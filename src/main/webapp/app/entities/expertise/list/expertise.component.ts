...
import { EntityArrayResponseType, ExpertiseService } from '../service/expertise.service';
...
export class ExpertiseComponent implements OnInit {
  ...
  trackId = (_index: number, item: IExpertise): number => this.expertiseService.getExpertiseIdentifier(item);
  ...
  protected onResponseSuccess(response: EntityArrayResponseType): void {
    ...
    this.expertise = dataFromBody;
  }

  protected fillComponentAttributesFromResponseBody(data: IExpertise[] | null): IExpertise[] {
    return data ?? [];
  }
  ...
  protected queryBackend(page?: number, predicate?: string, ascending?: boolean): Observable<EntityArrayResponseType> {
    ...
    return this.expertiseService.query(queryObject).pipe(tap(() => (this.isLoading = false)));
  }
