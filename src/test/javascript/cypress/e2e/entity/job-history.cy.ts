...
describe('JobHistory e2e test', () => {
  ...
  describe('new JobHistory page', () => {
    ...
    it('should create an instance of JobHistory', () => {
      cy.get(`[data-cy="startDate"]`).type('2024-08-31T01:07').blur().should('have.value', '2024-08-31T01:07');

      cy.get(`[data-cy="endDate"]`).type('2024-08-30T08:04').blur().should('have.value', '2024-08-30T08:04');
