    ...
    public Optional<JobHistory> partialUpdate(JobHistory jobHistory) {
        ...
        return jobHistoryRepository
            ...
            .map(existingJobHistory -> {
                ...
                if (jobHistory.getFile() != null) {
                    existingJobHistory.setFile(jobHistory.getFile());
                }
                if (jobHistory.getFileContentType() != null) {
                    existingJobHistory.setFileContentType(jobHistory.getFileContentType());
                }
