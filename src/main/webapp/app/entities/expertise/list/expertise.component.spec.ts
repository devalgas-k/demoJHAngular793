...
describe('Expertise Management Component', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [RouterTestingModule.withRoutes([{ path: 'expertise', component: ExpertiseComponent }]), HttpClientTestingModule],
  ...
  describe('trackId', () => {
    it('Should forward to expertiseService', () => {
      const entity = { id: 123 };
      jest.spyOn(service, 'getExpertiseIdentifier');
      const id = comp.trackId(0, entity);
      expect(service.getExpertiseIdentifier).toHaveBeenCalledWith(entity);
